...
Calculator:** Wrap your code from [Exercise 10-6](../chapter_10/tiy-ch10.md#ch10exe6) in
...
`except` block in [Exercise 10-8](../chapter_10/tiy-ch10.md#ch10exe8) to fail silently
...
Combine the two programs from [Exercise 10-11](../chapter_10/tiy-ch10.md#ch10exe11) into
