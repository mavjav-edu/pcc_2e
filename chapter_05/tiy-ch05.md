...
an alien as you did in [Exercise 5-3](../chapter_05/tiy-ch05.md#ch5exe3), and write an
`if`-`else` chain.
...
#3:** Turn your `if`-`else` chain from [Exercise 5-4](../chapter_05/tiy-ch05.md#ch5exe4)
